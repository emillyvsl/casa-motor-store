<x-app-layout>
    <x-header title="Cadastrar Produto" subtitle="Adicione um novo produto ao catálogo"
                            ...
                            <div class="space-y-6">
                                        ...
                                        <div id="shippingTags"
                                            ...
                                            @foreach ($shippingProfiles as $profile)
                                                <button type="button" data-id="{{ $profile->id }}"
                                                    class="shipping-tag px-4 py-2 rounded-full border border-gray-300 text-sm text-gray-700 bg-gray-50 hover:bg-orange-50 hover:border-orange-400 transition-all duration-200">
                                                    {{ $profile->name }}
                                                </button>
                                            @endforeach
                                        </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" rows="4"
                                        ...
                                        placeholder="Descreva as características técnicas, aplicações e benefícios do produto...">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <!-- Campo oculto que receberá o JSON -->
                        ...
                        <div class="p-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div
                                    ...
                                    <label class="flex items-center cursor-pointer">
                                        <input type="checkbox" name="allow_out_of_stock_sales"
                                            ...
                                            {{ old('allow_out_of_stock_sales') ? 'checked' : '' }} class="">
                                ...
                                <div id="outOfStockSettings"
                                    class="space-y-6 {{ old('allow_out_of_stock_sales') ? '' : 'hidden' }}">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="number" name="max_backorder"
                                                    ...
                                                    placeholder="Ex: 50"
                                                    {{ old('allow_out_of_stock_sales') ? '' : 'disabled' }}>
                                                <div class="absolute right-3 top-3.5">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="number" name="backorder_delivery_days"
                                                    value="{{ old('backorder_delivery_days', 15) }}"
                                                    class="w-full px-4 py-3.5 bg-white border border-purple-200 rounded-xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                                                    placeholder="Ex: 15"
                                                    {{ old('allow_out_of_stock_sales') ? '' : 'disabled' }}>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="out_of_stock_message"
                                            ...
                                            {{ old('allow_out_of_stock_sales') ? '' : 'disabled' }}>{{ old('out_of_stock_message', 'Produto em reposição. Entrega em até 15 dias úteis.') }}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <h4 class="text-lg font-medium text-gray-900 mb-2">Arraste as imagens aqui</h4>
                                ...
                                <div id="imagePreview" class="hidden">
                                    <h4 class="text-sm font-semibold text-gray-900 mb-3">Pré-visualização</h4>
