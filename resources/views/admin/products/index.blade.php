<x-app-layout>
    <div class=" mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between py-6 border-b border-gray-200">
            <div class="flex items-center space-x-4">
                <div class="bg-gradient-to-r from-orange-500 to-amber-500 p-3 rounded-xl shadow-sm">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Catálogo de Produtos</h2>
                    <p class="mt-1 text-sm text-gray-600">Gerencie e acompanhe todos os produtos do seu inventário</p>
                </div>
            </div>
            <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3">
                <button
                    class="inline-flex items-center px-4 py-2.5 border border-gray-300 text-gray-700 text-sm font-medium rounded-xl bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-200 shadow-sm">
    ...
    <div class="py-8">
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    <div class="flex items-center">
                        <div class="p-3 rounded-xl bg-green-50 text-green-500 mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    <div class="flex items-center">
                        <div class="p-3 rounded-xl bg-red-50 text-red-500 mr-4">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            ...
                                            <p class="font-medium text-gray-900">{{ $product->category?->name ?? '—' }}
                                            </p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center">
                                                @if ($product->stock > 10)
                                                    ...
                                                    <span class="text-xs text-green-600">Em estoque</span>
                                                @elseif ($product->stock > 0)
                                                    <span class="flex h-2 w-2 mr-1">
                                                        <span
                                                            class="relative inline-flex rounded-full h-2 w-2 bg-amber-500"></span>
                                                    </span>
                                                    <span class="text-xs text-amber-600">Estoque baixo</span>
                                                @else
                                                    <span class="flex h-2 w-2 mr-1">
                                                        <span
